    ...
    return (
        <div className='formabs'>
            <form className='Formo4ka'>
                <MyInput className='Inputi' value={img} onChange={e => setImg(e.target.value)} type='text' placeholder='Картинка' />
                ...
                <MyInput className='Inputi' value={silka} onChange={e => setSilka(e.target.value)} type='text' placeholder='Ссылка' />
